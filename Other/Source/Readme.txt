...
user in an INI file next to TeXstudioPortable.exe called TeXstudioPortable.ini.
...
copy AppNamePortable.ini from this directory to TeXstudioPortable.ini next to
TeXstudioPortable.exe. The options in the INI file are as follows:
